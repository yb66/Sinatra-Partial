...
[AppWithUnderscores, AppWithUnderscoresAndErb, AppWithUnderscoresAndErbAndSubdirs
].each do |c|
  describe c.to_s do
...
[AppNoUnderscores,AppNoUnderscoresAndSlim].each do |c|
  describe c.to_s do
    include_context "Running different apps", c
    it_should_behave_like "all in examples dir" do
      let(:expected) { %q!<html><head></head><body><p>Time is #{Time.now}</p><ul><li class='klassic'>This</li><li class='klassic'>is</li><li class='klassic'>all</li><li class='klassic'>new</li></ul><p>A is A</p><p>B is B</p><p>C is C</p><p>D is D</p><p>Hello, World</p><p>Show me magic</p></body></html><div class="container"><a href="/mylink">This is is a link</a></div>! }
    end
  end
end